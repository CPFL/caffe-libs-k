...
struct NdarrayCallPolicies : public bp::default_call_policies {
  ...
  PyObject* postcall(PyObject* pyargs, PyObject* result) {
    ...
    //PyObject *arr_obj = PyArray_SimpleNewFromData(num_axes, dims.data(), NPY_FLOAT32, data);//fujitsu
    PyObject *arr_obj = PyArray_SimpleNewFromData(num_axes, &dims[0], NPY_FLOAT32, data);
